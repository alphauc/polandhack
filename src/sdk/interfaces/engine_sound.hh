...
#define PITCH_HIGH		120
	...
	public:
		...
		virtual int EmitSound( IRecipientFilter& filter, int iEntIndex, int iChannel, const char *pSoundEntry, unsigned int nSoundEntryHash, const char *pSample,
			...
			const vec3 *pOrigin = NULL, const vec3 *pDirection = NULL, utl_vector< vec3 >* pUtlVecOrigins = NULL, bool bUpdatePositions = true, float soundtime = 0.0f, int speakerentity = -1 ) = 0;
		...
		virtual void	get_active_sounds( utl_vector<sound_info>& sndlist ) = 0;
